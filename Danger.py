...
FORWARD_CHANNEL_ID = -1001810861530
CHANNEL_ID = -1001810861530
error_channel_id = -1001810861530
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="♻️ 𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ♻️", url="https://t.me/+HM67f9U_AB82MDY1")
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/c/1810861530/2711")
            markup.add(button1)
            markup.add(button2)
        else:
            ...
            button = types.InlineKeyboardButton(
                text="💢 𝐉𝐎𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 💢", url="https://t.me/VIP_OWNER9")
            markup.add(button)
...
def canary_command(message):
    ...
    button1 = types.InlineKeyboardButton(
        ...
        url="https://t.me/c/1810861530/2701")
    button2 = types.InlineKeyboardButton(
